...
- "x": the X/Twitter post. Max 240 characters including hashtags. 1 to 2 lowercase hashtags.
...
- "hashtags": 4 to 6 lowercase hashtags as an array (no # symbol), for Instagram.
...
const SAMPLE_WEEK = [
  { angle: 'why we built it', x: 'We got tired of dating apps that treat a disability like a plot twist. So we built one that does not. Able2Love is live, free on Google Play. #disabilitydating', headline: 'Dating apps were not built for us. So we built one.', caption: 'We got tired of dating apps that treat a disability like a plot twist you break gently in the DMs. So we built the one we actually wanted. Free on Google Play, link in bio.', hashtags: ['disabilitydating', 'inclusivedating', 'disabilitycommunity', 'able2love'] },
  { angle: 'disclosure', x: 'Your disability should not be a speech you rehearse in the DMs. On Able2Love it is a card on your profile. Set it out once, done. Free on Google Play. #disabilitydating', headline: 'Your access needs. On a card, not a confession.', caption: 'On most apps your disability is a speech you rehearse in the DMs. On Able2Love it is a card on your profile. You set it out once, done. Free on Google Play, link in bio.', hashtags: ['disabilitydating', 'disabilitycommunity', 'accessibility', 'able2love'] },
  { angle: 'bad bios', x: 'Red flag: "Love to laugh, love to travel, no drama." A personality, or an airport? Green flags only on Able2Love. Free on Google Play. #dating', headline: '"Love to laugh, love to travel, no drama." A personality, or an airport?', caption: 'Green flags only: asks instead of assumes, does not treat access needs like a favour, knows a wheelchair is freedom not a tragedy. Write a better bio. Free on Google Play, link in bio.', hashtags: ['dating', 'disabilitydating', 'greenflags', 'able2love'] },
];
