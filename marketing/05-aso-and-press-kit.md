# App Store Optimization & Press Kit
...
### Keyword targets
`disability dating`, `inclusive dating`, `accessible dating app`, `disabled singles`, `wheelchair dating`, `chronic illness dating`, `neurodivergent dating`, `deaf dating`, `LGBTQ disability`, `special needs dating` *(users search this term even though we don't use it in our own voice — include it in the keyword field only, never in visible copy)*.
...
> • **Accessible by design** — screen-reader friendly, high-contrast, large touch targets. Accessibility is the foundation, not a setting.
> • **A real community** — daters, allies, and partners who show up without stigma.
> • **Made for connection** — swipe, match, and chat, with a map to find people nearby.
>
...
1. "You belong here."
2. "Disclosure on your terms — optional and opt-in."
3. "Accessible by design."
4. "Match with people who get it."
5. "Real conversations, real connection."

### Ratings/reviews prompt
Trigger the review prompt after a positive moment (a first match or a good conversation), never on app open. Ask happy users directly; route unhappy users to support first.
...
- [ ] App screenshots (5, with captions above)
- [ ] Founder headshots + bios
- [ ] 30–60s brand video (open-captioned)
- [ ] One-page fact sheet
